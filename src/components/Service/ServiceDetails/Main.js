              ...
              <div className="service-detail">
                <div className="content-box">
                  ...
                  >
                    ...
                    technology. HIFEM® uses a powerful but harmless form of
                    electromagnetic stimulation to contract the muscles in a
                    targeted area. These magnetic fields create electrical
                    currents, which are passed to the muscles. When these
                    magnetic pulses are fast enough, they force the muscles to
                    contract, much like they do during times of strenuous
                    exercise. Therefore, when the muscles contract enough times,
                    they begin to build muscles and burn fat. This gives
                    treatments like Emsculpt Neo® its contouring power.
                  </p>
                  <h2 style={{ fontFamily: "Gloock,serif", color: "black" }}>
                    What area of the body does Emsculpt Neo treat?{" "}
                  </h2>
                  ...
                  <p
                    style={{ fontFamily: "LibreBaskerville", fontSize: "16px" }}
                  >
                    Standard treatment is 4 30-minute sessions
                  </p>
                  <h3 style={{ fontFamily: "Gloock,serif", color: "black" }}>
                  ...
                  <p
                    style={{ fontFamily: "LibreBaskerville", fontSize: "16px" }}
                  >
                    EMSCULPT NEO treatments may feel intense but should never be
                    painful. What happens to the fat that is eliminated by

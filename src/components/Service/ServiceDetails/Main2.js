            ...
            <div className="col-lg-8 col-md-12 col-sm-12 order-2">
              <div className="service-detail">
                <div className="content-box">
                  ...
                  >
                    EMSELLA uses electromagnetic energy to cause deep pelvic
                    floor muscle stimulation without getting undressed! A single
                    BTL EMSELLA session brings thousands of Kegel-like
                    contractions which help you train your muscles without any
                    effort. Scientific research shows that 95% of treated
                  ...
                  <p
                    style={{ fontFamily: "LibreBaskerville", fontSize: "16px" }}
                  >
                    EMSELLA is a great option for women of any age who desire a
                    non-invasive solution for urinary incontinence and
                    improvement in their quality of life. Due to factors such as
                    the body's normal aging, childbirth or menopause, the pelvic
                    floor muscles decondition and insufficiently support the
                    pelvic organs. These factors directly correlate with urinary
                    incontinence. Emsella treatments for men have substantially
                    improved many individuals' quality of life, confidence,
                    sexual health, and sexual performance. Treatments are quick,
                    non-surgical, and pain-free, providing men with a
                    comfortable solution to stressful conditions. The pelvic
                    floor muscles support the bladder, rectum, and prostate.
                    When these muscles become weakened, it can lead to issues
                    such as urinary incontinence, erectile dysfunction, and

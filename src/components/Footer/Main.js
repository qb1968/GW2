              ...
              <div className="col-xl-4 col-lg-4 col-sm-6">
                <div className="footer-widget mb-30">
                  ...
                  <div className="footer-link">
                    ...
                    >
                      At Gentle Wellness our mission is to provide a world class
                      spa experience while providing personalized services to
                      each client and enhance their natural beauty. We strive to
                      build rewarding relationships with our clients and
                      community, through knowledge, wellness, and superior
                      service.
                    </p>
                  </div>
                </div>

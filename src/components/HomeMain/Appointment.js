          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="contact-bg">
                <div className="section-title center-align">
                  <h2 style={{ fontFamily: "Alex Brush", color: "black" }}>
                    Request an Appointment
                  </h2>
                  <p style={{ fontFamily: "LibreBaskerville" }}>
                    Fill your info out to request an appointment with one of our
                    specialists.
                  </p>
                </div>
                <form
            ...
            <div className="col-lg-6">
              <div className="opening-time">
                ...
                <h2 style={{ fontFamily: "fantasy", color: "black" }}>
                  3150 W.Ward Rd
                </h2>
                <h2 style={{ fontFamily: "fantasy", color: "black" }}>
                  Suite 304
                ...
                <h3 style={{ fontFamily: "fantasy", color: "black" }}>
                  Opening Hours
                </h3>
                <div className="text">
                  <div

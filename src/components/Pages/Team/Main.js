...
const Main = () => {
  return (
    <>
      ...
      >
        <h1 style={{fontFamily:"Alex Brush", textAlign: "center", color: "black" }}>Our Team</h1>
            ...
            <div className="col-xl-4">
              <div className="single-team mb-45">
                ...
                <div className="team-info">
                  <h4>
                    <Link to="" style={{fontFamily:"LibreBaskerville"}}>Dr.Sclater</Link>
                  </h4>
                  <p style={{fontFamily:"LibreBaskerville",fontWeight:"bold"}}>Owner</p>
                  <p style={{fontFamily:"LibreBaskerville"}}>Dr. Sclater is a Calvert County native, and strongly believes in local businesses supporting each
...
Spa as a means to enhance her patient’s natural beauty through non-invasive treatment.</p>
            ...
            <div className="col-xl-4">
              <div className="single-team mb-45">
                ...
                <div className="team-info">
                  <h4>
                    <Link to="" style={{fontFamily:"LibreBaskerville"}}>Melissa</Link>
                  </h4>
                  <p style={{fontFamily:"LibreBaskerville",fontWeight:"bold"}}>Office Manager</p>
                  <p style={{fontFamily:"LibreBaskerville"}}>Melissa loves the challenge of managing a team…her knack for organization and her ability to
...
excited to bring her skill set to Gentle Wellness.</p>
            ...
            <div className="col-xl-4">
              <div className="single-team mb-45">
                ...
                <div className="team-info">
                  <h4>
                    <Link to="" style={{fontFamily:"LibreBaskerville"}}>Melinda</Link>
                  </h4>
                  <p style={{fontFamily:"LibreBaskerville",fontWeight:"bold"}}>Esthetician</p>
                  <p style={{fontFamily:"LibreBaskerville"}}>Melinda is a Maryland Licensed Esthetician specializing in results-oriented facials. Melinda is passionate about repairing damaged skin and educating others on how to care for their skin at home.  Melinda has a passion for learning and is constantly exploring new methods of skin therapy to introduce into her treatment room. Melinda is an Aquarius who loves all things history, mythology, and family genealogy! She can often be found adventuring in DC with her boyfriend, James, or snuggling with Apollo, their Australian Shepherd puppy. </p>
            ...
            <div className="col-xl-4">
              <div className="single-team mb-45">
                ...
                <div className="team-info">
                  <h4>
                    <Link to="" style={{fontFamily:"LibreBaskerville"}}>Maddy</Link>
                  </h4>
                  <p style={{fontFamily:"LibreBaskerville",fontWeight:"bold"}}>Eyelash Tech</p>
                  <p style={{fontFamily:"LibreBaskerville"}}>
...
Maddy recently moved to Calvert County from California. She has been an eye lash technician for over a year of experience. Maddy’s passion for enhancing your own natural beauty has been her main focus when treating her clients. She spends her days off in the gym or practicing new techniques, she takes pride in her artistry and is excited to share it with you!</p>
            ...
            <div className="col-xl-4">
              <div className="single-team mb-45">
                ...
                <div className="team-info">
                  <h4>
                    <Link to="" style={{fontFamily:"LibreBaskerville"}}>Jessica</Link>
                  </h4>
                  <p style={{fontFamily:"LibreBaskerville",fontWeight:"bold"}}>Microblading Tech</p>
                 <p style={{fontFamily:"LibreBaskerville"}}>I have been a Dental Hygienist for 15 years working at Gentle Family Dentistry in Dunkirk, MD.
